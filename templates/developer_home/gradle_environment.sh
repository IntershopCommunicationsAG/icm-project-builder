...
COMPONENTSETNAME=a_responsive
ASSEMBLYNAME=inspired-b2x

COMPONENTSET=${DEVELOPER_BASE}/$COMPONENTSETNAME
ASSEMBLY=${DEVELOPER_BASE}/$ASSEMBLYNAME
SERVER=${DEVELOPER_BASE}/server
JAVADOC=${DEVELOPER_BASE}/javadoc
WORKSPACE=${DEVELOPER_BASE}/workspace
REPO=${DEVELOPER_BASE}/repo
